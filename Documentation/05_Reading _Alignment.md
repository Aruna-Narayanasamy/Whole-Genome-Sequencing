...
## 2.Aligning Reads to the Reference Genome
 ...
 - **Command**:
   ```bash
   cd /workspaces/Whole-Genome-Sequencing/Output_Files/
...
## 5.Indexing the Sorted BAM File
 ...
 - **command**:
   ```bash
    samtools index Output_Files/Alignment_Files/ERR5743893.sorted.bam
   ```
...
## 6.Organizing the Output
 ...
 - **Command**:
   ```bash
   mkdir /workspaces/Whole-Genome-Sequencing/Output_Files/Alignment_Files
...
## 7.Creating FASTA Index Using Samtools
 ...
 - **Commands**:
   ```bash
   cd /workspaces/Whole-Genome-Sequencing/Output_Files/Indexing
