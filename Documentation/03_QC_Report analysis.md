# Quality Assesment of FASTQ Files
 ...
 ## 1.Creating main output directory
  ...
  - **Command**:
   ```bash
    mkdir /workspaces/Whole-Genome-Sequencing/Output_Files
   ```
 ...
 ## 2.Creating the QC_Reports directory inside Output_Files
  ...
  - **Command**:
   ```bash
    mkdir /workspaces/Whole-Genome-Sequencing/Output_Files/QC_Reports
```
 ...
 ## 3.Running FastQC
  ...
  - **Command**:
  ```bash
    fastqc ERR5743893_1.fastq.gz ERR5743893_2.fastq.gz -o /workspaces/Whole-Genome-Sequencing/Output_Files/QC_Reports
```
 ...
 ## 4.Opening FastQC HTML Files
  ...
  - **Commands**:
   ```bash
    cd /workspaces/Whole-Genome-Sequencing/Output_Files/QC_Reports python3 -m http.server 8000
   ```
 ...
 ## 5.Decompressing FASTQ Files 
  ...
  - **Commands**:
   ```bash
     gunzip -dc ERR5743893_1.fastq.gz > /workspaces/Whole-Genome-Sequencing/Output_Files/ERR5743893_1.fastq
