# Reference Genome Indexing
 ...
 ## 2.Copying the Reference Genome into the Indexing Directory
  ...
  - **Command**:
    ```bash
    cp /workspaces/Whole-Genome-Sequencing/Reference_Genome/MN908947.fasta /workspaces/Whole-Genome-Sequencing/Output_Files/Indexing/
    ```
 ...
 ## 3.Indexing the reference genome with BWA  
  ...
  - **Command**:
    ```bash
    bwa index /workspaces/Whole-Genome-Sequencing/Output_Files/Indexing/MN908947.3.fasta
     ```
