# Data Reterival from ENA Database
 ...
 ## 1.Reference Genome download 
   ...
   - The reference genome file MN908947.3.fasta used in this workflow was downloaded manually from the NCBI database on the local computer and then uploaded to the repository under the: Reference_Genome directory for the further analysis.
